...
public class Firebase_Search_Less_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_search_less_main);
        ...
        button_back_2 = findViewById(R.id.back6);

        button_back_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Firebase_Search_Less_MainActivity.this, HomePage.class);
